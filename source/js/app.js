...
var deltaScreen, direction, indexSlide, nextSlide, prevSlide, pressKey, raceCall, Trigger_Anim = false, Trig_FL = true;
    ...
    return {
        inn: function (raceCall) {
            if (raceCall === 'road2_trans_in-end') {
                ...
                $('#diraman6').velocity({opacity: 1}, {duration: 100, easing: 'easeIn', complete: function () {
                ...
                $('#h4fic3').velocity({opacity: 1}, {delay: 1100, duration: 1000, easing: 'easeIn', complete: function () {
                    console.log('sec4_hf2_inn-end');
                    indexSlide = 'sec4-r2';
                    nextSlide = 'sec5';
                    prevSlide = 'sec4-r1';
    ...
    return {
        inn: function (raceCall) {
            if (raceCall === 'road2_show-end' && nextSlide === 'sec4-r1') {
                ...
                $('#diraman3').velocity({opacity: 1}, {duration: 100, easing: 'easeIn', complete: function () {
                ...
                $('#diraman4').velocity({opacity: 1}, {delay: 300, duration: 100, easing: 'easeIn', complete: function () {
                ...
                $('#diraman5').velocity({opacity: 1}, {delay: 500, duration: 100, easing: 'easeIn', complete: function () {
                ...
                $('#h4ic4').velocity({opacity: 1}, {delay: 1400, duration: 1000, easing: 'easeIn', complete: function () {
                    indexSlide = 'sec4-r1';
                    nextSlide = 'sec4-r2';
                    prevSlide = 'sec4';
                    Trigger_Anim = true;
    ...
    return {
        inn: function (raceCall) {
            if (raceCall === 'road_trans_in-end' && nextSlide === 'sec3') {
                ...
                $('#ic_41_1').velocity({opacity: 1}, {delay:100, duration: 100, easing: 'easeIn', complete: function () {
                ...
                $('#ic_41_2').velocity({opacity: 1}, {delay:500, duration: 100, easing: 'easeIn', complete: function () {
                    $(this).addClass('active');
                ...
                $('#ic_41_3').velocity({opacity: 1}, {delay:100, duration: 100, easing: 'easeIn', complete: function () {
                    $(this).addClass('active');
                ...
                $('#ic_41_4').velocity({opacity: 1}, {delay:500, duration: 100, easing: 'easeIn', complete: function () {
                    $(this).addClass('active');
                ...
                $('#ic_41_5').velocity({opacity: 1}, {delay:100, duration: 100, easing: 'easeIn', complete: function () {
                    $(this).addClass('active');
